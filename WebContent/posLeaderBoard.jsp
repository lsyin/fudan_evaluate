...
<h5>The LeaderBoard show the result of your evaluation.You will find your pos_evaluation result at here.</h5> 
</div>
 <div id="testtable"></div>  
 
 <script>	 
 $(document).ready(function() {
		var _url = "<%=response.encodeURL("getScore.do?type=pos")%>";
		jQuery.ajax({
			url : _url,
			type : "get",
			dataType : "json",
